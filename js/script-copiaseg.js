...
h2.innerHTML = `<b>CHOOSE THE CATEGORY YOU ARE INTERESTED IN:</b>` */
    ...
    read.setAttribute("class", "readMore");
        ...
        document.getElementsByClassName("readMore")[i].addEventListener("click", (event) => {
...
// https://api.nytimes.com/svc/books/v3/lists/overview.json?api-key=VEv4zKkH6mydKKCzo97zoOhuO0w0801c
